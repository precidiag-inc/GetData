...
def test_fasta_file(
        ...
        primers={'AGAGTTTGATC[AC]TGG[CT]TCAG': 'v1', 'AGAGTTTGATC[AC]TGGCTCAG': 'v1_b',
                 ...
                 'GACTAC[AGCT][GCA]GGGTATCTAATCC': 'v4_b', 'A[CT]TGGG[CT][ACT]TAAAG[ACGT]G': 'v5'},
        max_start=25,
        min_primer_len=10,
        num_reads=1000,
        min_fraction=0.25,
...
def main(argv):
	...
	parser.add_argument('-p', '--sra-path', help='path to the sratoolkit binary', default='/cm/shared/c3ddb/sratoolkit/2.8.0/bin')
